...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, num_traps=3, custom_walls=None):
        ...
        # Step 2.1: Generate toxic traps safely avoiding start (0,0), walls, and food positions
    ...
    def get_percept(self) -> dict:
        # Step 2.2: Add 'smells_toxin' sensor key to dictionary
        return {
    ...
    def execute_action(self, action: str):
        ...
        # Step 2.3: Decrement score by 15 if agent steps on a toxic trap
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        # Step 2.3: Render custom purple shapes for toxic traps
        for tx, ty in self.env.toxic_traps:
            offset = self.cell_size * 0.25
            x1 = tx * self.cell_size + offset
            y1 = (self.env.height - 1 - ty) * self.cell_size + offset
            self.canvas.create_oval(x1, y1, x1 + self.cell_size * 0.5, y1 + self.cell_size * 0.5, fill="#8b5cf6",
                                    outline="#6d28d9")
